...
router.route("/").post(createOrderProduct).get(getOrderProducts);
/* 
...
router
  .route("/:id")
  .get(getOrderProductById)
  .put(updateOrderProduct)
...
router.route("/:id/status").patch(updateStatusOrderProduct);
